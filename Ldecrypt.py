...
def param():
    ...
    epilog='(c) Автор: *** <***@gmail.com> 08.12.2016 г.'
    )
    # Имя файла для расшифрования
    parser.add_argument('-f','--fname', default='encrypted.txt')
    # Имя файла с ключевой информацией
    parser.add_argument('-k','--key', default='key.txt')

    args = parser.parse_args()
    return [args.fname, args.key]
...
##
##    file_out.close()
##    return[zap0,zap1,zap2,fname,keylen]
...
#====================================================================
crypt(f1 = 'encrypted.txt',f2 = 'decrypted.txt',c = coutn_iter)
#====================================================================
